...
var letterOptions = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s",
    "t", "u", "v", "w", "x", "y", "z"]
...
if (userGuess === computerGuess) {
   ...
   var wins = wins++
    ...
    // reassign new computer guess
        ...
        var losses++ lossesText = document.getElementById("losses-text");
)
...
< p id = "userLosses" > Losses:</p>
        ...
        <p id="yourGuessesSoFar">Your Guesses So Far:</p>
